...
PathPlanner::PathPlanner()
    ...
    , mEdgeSize{0ul}
{
    this->ExecuteSampleCode();
}

void PathPlanner::Configure(const std::string &lanesInfoFileName)
{
    this->ParseLanesInfo(
        lanesInfoFileName,
        mConnectedLaneIdMap);
...
void PathPlanner::ParseLanesInfo(
...
void PathPlanner::ConstructGraph(const ConnectedLaneIdMap &connectedLaneIdMap)
{
...
std::size_t PathPlanner::ComputeEdgeSize(const ConnectedLaneIdMap &connectedLaneIdMap) const
{
...
bool PathPlanner::IsConnectedLaneIds(const std::vector<int32_t> &laneIds) const
{
...
void PathPlanner::ExecuteSampleCode()
{
