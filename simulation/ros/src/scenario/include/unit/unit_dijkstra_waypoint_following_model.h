#ifndef _UNIT_DIJKSTRA_WAYPOINT_FOLLOWING_MODEL_H_
#define _UNIT_DIJKSTRA_WAYPOINT_FOLLOWING_MODEL_H_
...
class DijkstraWaypointFollowingModel final : public Model
{

public:

    typedef std::shared_ptr<DijkstraWaypointFollowingModel> Ptr;

    DijkstraWaypointFollowingModel();
    DijkstraWaypointFollowingModel(const DijkstraWaypointFollowingModel &) = delete;
    DijkstraWaypointFollowingModel &operator=(const DijkstraWaypointFollowingModel &) = delete;
    virtual ~DijkstraWaypointFollowingModel() = default;
...
private:
    ...
    {return "dijkstra_waypoint_following_";}
    ...
    std::vector<motion::DijkstraWaypointFollowingConfig> mMotionConfigs;
...
#endif // #ifndef _UNIT_DIJKSTRA_WAYPOINT_FOLLOWING_MODEL_H_
