#ifndef _UNIT_ALKS_CUT_IN_MODEL_H_
#define _UNIT_ALKS_CUT_IN_MODEL_H_
...
namespace unit
{
    ...
    class AlksCutInModel final : public Model
    {
        using YawRateFilter   = math::MovingAverageFilter<math::real_t>;
        using MovingAvgFilter = math::MovingAverageFilter<math::real_t>;

    public:
        typedef std::shared_ptr<AlksCutInModel> Ptr;

        AlksCutInModel();
        AlksCutInModel(const AlksCutInModel&)            = delete;
        AlksCutInModel& operator=(const AlksCutInModel&) = delete;
        virtual ~AlksCutInModel();
    ...
    private:
        ...
        std::vector<motion::AlksCutInConfig>         mMotionConfigs;
        ...
        MovingAvgFilter mEgoStableSpeedFilter;
