...
if("FALSE" STREQUAL "TRUE")
  set(rrt_planning_SOURCE_PREFIX /repository/ros/src/itri/rrt_planning)
  set(rrt_planning_DEVEL_PREFIX /repository/ros/devel)
  ...
  set(rrt_planning_INSTALL_PREFIX /repository/ros/install)
...
if(NOT "include " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'BarryHao <yhhao@itri.org.tw>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rrt_planning' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rrt_planning_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rrt_planning")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rrt_planning_NUM_DUMMY_TARGETS)
      set(rrt_planning_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rrt_planning::wrapped-linker-option${rrt_planning_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rrt_planning_NUM_DUMMY_TARGETS "${rrt_planning_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rrt_planning::wrapped-linker-option${rrt_planning_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rrt_planning_LIBRARIES "${interface_target_name}")
...
set(depends "steering_functions")
