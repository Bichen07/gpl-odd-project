...
let ParkingLanePoint = require('./ParkingLanePoint.js');
...
class ParkingLane {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.points.forEach((val) => {
      bufferOffset = ParkingLanePoint.serialize(val, buffer, bufferOffset);
    });
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.points[i] = ParkingLanePoint.deserialize(buffer, bufferOffset)
    }
    ...
    for (let i = 0; i < len; ++i) {
      data.waypoints[i] = Waypoints.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ParkingLane(null);
    if (msg.id !== undefined) {
      resolved.id = msg.id;
    }
    else {
    ...
    if (msg.points !== undefined) {
      ...
      for (let i = 0; i < resolved.points.length; ++i) {
        resolved.points[i] = ParkingLanePoint.Resolve(msg.points[i]);
      }
    }
    else {
      resolved.points = []
    ...
    if (msg.waypoints !== undefined) {
      ...
      for (let i = 0; i < resolved.waypoints.length; ++i) {
        resolved.waypoints[i] = Waypoints.Resolve(msg.waypoints[i]);
      }
    }
    else {
      resolved.waypoints = []
