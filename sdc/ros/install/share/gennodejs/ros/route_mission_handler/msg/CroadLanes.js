...
class CroadLanes {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('cr1')) {
        this.cr1 = initObj.cr1
      }
      else {
        this.cr1 = new Croad();
      }
      if (initObj.hasOwnProperty('cr2')) {
        this.cr2 = initObj.cr2
      }
      else {
        this.cr2 = new Croad();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [cr1]
    bufferOffset = Croad.serialize(obj.cr1, buffer, bufferOffset);
    // Serialize message field [cr2]
    bufferOffset = Croad.serialize(obj.cr2, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CroadLanes(null);
    // Deserialize message field [cr1]
    data.cr1 = Croad.deserialize(buffer, bufferOffset);
    // Deserialize message field [cr2]
    data.cr2 = Croad.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    let length = 0;
    length += Croad.getMessageSize(object.cr1);
    length += Croad.getMessageSize(object.cr2);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CroadLanes(null);
    if (msg.cr1 !== undefined) {
      resolved.cr1 = Croad.Resolve(msg.cr1)
    }
    else {
      resolved.cr1 = new Croad()
    }

    if (msg.cr2 !== undefined) {
      resolved.cr2 = Croad.Resolve(msg.cr2)
    }
    else {
      resolved.cr2 = new Croad()
    }
