...
class LongitudinalData {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.float32(obj.accelerations, buffer, bufferOffset, null);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.accelerations = _arrayDeserializer.float32(buffer, bufferOffset, null)
  ...
  static getMessageSize(object) {
    ...
    length += 4 * object.accelerations.length;
