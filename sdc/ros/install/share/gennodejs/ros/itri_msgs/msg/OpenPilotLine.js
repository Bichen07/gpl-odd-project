...
class OpenPilotLine {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.uint8(obj.probability, buffer, bufferOffset);
    // Serialize message field [coefficient]
    bufferOffset = _arraySerializer.float32(obj.coefficient, buffer, bufferOffset, null);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new OpenPilotLine(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [probability]
    data.probability = _deserializer.uint8(buffer, bufferOffset);
    // Deserialize message field [coefficient]
    data.coefficient = _arrayDeserializer.float32(buffer, bufferOffset, null)
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += 4 * object.coefficient.length;
    return length + 5;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new OpenPilotLine(null);
