...
class ParkingStatus {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('parking_space')) {
        ...
        this.parking_space = new ParkingSpace();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ParkingSpace.serialize(obj.parking_space, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ParkingStatus(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [parking_space]
    data.parking_space = ParkingSpace.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += ParkingSpace.getMessageSize(object.parking_space);
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ParkingStatus(null);
    ...
    if (msg.parking_space !== undefined) {
      resolved.parking_space = ParkingSpace.Resolve(msg.parking_space)
    }
    else {
      resolved.parking_space = new ParkingSpace()
    }
