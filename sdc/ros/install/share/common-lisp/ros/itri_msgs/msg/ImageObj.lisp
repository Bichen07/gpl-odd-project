...
(cl:defclass <ImageObj> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (obj
    :reader obj
    :initarg :obj
    :type (cl:vector itri_msgs-msg:ImageRect)
   :initform (cl:make-array 0 :element-type 'itri_msgs-msg:ImageRect :initial-element (cl:make-instance 'itri_msgs-msg:ImageRect))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ImageObj>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ImageObj)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name itri_msgs-msg:<ImageObj> is deprecated: use itri_msgs-msg:ImageObj instead.")))
...
(cl:defmethod obj-val ((m <ImageObj>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader itri_msgs-msg:obj-val is deprecated.  Use itri_msgs-msg:obj instead.")
  (obj m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ImageObj>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'obj)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'itri_msgs-msg:ImageRect))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ImageObj>)))
  ...
  "e1150ee7cd207f22917c6b546320d928")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ImageObj)))
  "Returns md5sum for a message object of type 'ImageObj"
  "e1150ee7cd207f22917c6b546320d928")
