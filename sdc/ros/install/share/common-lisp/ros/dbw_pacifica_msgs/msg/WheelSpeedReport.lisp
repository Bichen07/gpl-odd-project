...
(cl:defclass <WheelSpeedReport> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (rear_right
    ...
    :initform 0.0)
   (wheel_speed_type
    :reader wheel_speed_type
    :initarg :wheel_speed_type
    :type dbw_pacifica_msgs-msg:WheelSpeedType
    :initform (cl:make-instance 'dbw_pacifica_msgs-msg:WheelSpeedType)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <WheelSpeedReport>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WheelSpeedReport)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dbw_pacifica_msgs-msg:<WheelSpeedReport> is deprecated: use dbw_pacifica_msgs-msg:WheelSpeedReport instead.")))
...
(cl:ensure-generic-function 'wheel_speed_type-val :lambda-list '(m))
(cl:defmethod wheel_speed_type-val ((m <WheelSpeedReport>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_pacifica_msgs-msg:wheel_speed_type-val is deprecated.  Use dbw_pacifica_msgs-msg:wheel_speed_type instead.")
  (wheel_speed_type m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <WheelSpeedReport>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'rear_right))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'wheel_speed_type) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <WheelSpeedReport>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'wheel_speed_type) istream)
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<WheelSpeedReport>)))
  ...
  "dbw_pacifica_msgs/WheelSpeedReport")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'WheelSpeedReport)))
  "Returns string type for a message object of type 'WheelSpeedReport"
  "dbw_pacifica_msgs/WheelSpeedReport")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<WheelSpeedReport>)))
  ...
  "7f27720c7c80e612329b2205902e5bba")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'WheelSpeedReport)))
  "Returns md5sum for a message object of type 'WheelSpeedReport"
  "7f27720c7c80e612329b2205902e5bba")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<WheelSpeedReport>)))
  ...
  (cl:format cl:nil "Header header~%~%# Wheel speeds (RPM or km/h or rad/sec)~%float32 front_left~%float32 front_right~%float32 rear_left~%float32 rear_right~%~%WheelSpeedType wheel_speed_type~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: dbw_pacifica_msgs/WheelSpeedType~%uint8 value~%~%uint8 ANGULAR = 0~%uint8 LINEAR = 1~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'WheelSpeedReport)))
  "Returns full string definition for message of type 'WheelSpeedReport"
  (cl:format cl:nil "Header header~%~%# Wheel speeds (RPM or km/h or rad/sec)~%float32 front_left~%float32 front_right~%float32 rear_left~%float32 rear_right~%~%WheelSpeedType wheel_speed_type~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: dbw_pacifica_msgs/WheelSpeedType~%uint8 value~%~%uint8 ANGULAR = 0~%uint8 LINEAR = 1~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <WheelSpeedReport>))
  (cl:+ 0
     ...
     4
     4
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'wheel_speed_type))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <WheelSpeedReport>))
  ...
  (cl:list 'WheelSpeedReport
    ...
    (cl:cons ':wheel_speed_type (wheel_speed_type msg))
))
