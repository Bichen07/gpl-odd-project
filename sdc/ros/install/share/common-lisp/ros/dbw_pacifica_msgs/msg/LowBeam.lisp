...
(cl:defmethod cl:initialize-instance :after ((m <LowBeam>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LowBeam)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dbw_pacifica_msgs-msg:<LowBeam> is deprecated: use dbw_pacifica_msgs-msg:LowBeam instead.")))
