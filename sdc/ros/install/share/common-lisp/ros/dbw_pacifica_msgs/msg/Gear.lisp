...
(cl:defmethod cl:initialize-instance :after ((m <Gear>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Gear)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dbw_pacifica_msgs-msg:<Gear> is deprecated: use dbw_pacifica_msgs-msg:Gear instead.")))

(cl:ensure-generic-function 'gear-val :lambda-list '(m))
(cl:defmethod gear-val ((m <Gear>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_pacifica_msgs-msg:gear-val is deprecated.  Use dbw_pacifica_msgs-msg:gear instead.")
  (gear m))
