...
(cl:defmethod cl:initialize-instance :after ((m <TurnSignal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TurnSignal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dbw_pacifica_msgs-msg:<TurnSignal> is deprecated: use dbw_pacifica_msgs-msg:TurnSignal instead.")))
