...
(cl:defmethod cl:initialize-instance :after ((m <TrafficLight>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrafficLight)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name route_mission_handler-msg:<TrafficLight> is deprecated: use route_mission_handler-msg:TrafficLight instead.")))
...
(cl:ensure-generic-function 'laneIds-val :lambda-list '(m))
(cl:defmethod laneIds-val ((m <TrafficLight>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader route_mission_handler-msg:laneIds-val is deprecated.  Use route_mission_handler-msg:laneIds instead.")
  (laneIds m))
...
(cl:defmethod lightNum-val ((m <TrafficLight>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader route_mission_handler-msg:lightNum-val is deprecated.  Use route_mission_handler-msg:lightNum instead.")
  (lightNum m))

(cl:ensure-generic-function 'vps-val :lambda-list '(m))
(cl:defmethod vps-val ((m <TrafficLight>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader route_mission_handler-msg:vps-val is deprecated.  Use route_mission_handler-msg:vps instead.")
  (vps m))

(cl:ensure-generic-function 'vpe-val :lambda-list '(m))
(cl:defmethod vpe-val ((m <TrafficLight>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader route_mission_handler-msg:vpe-val is deprecated.  Use route_mission_handler-msg:vpe instead.")
  (vpe m))

(cl:ensure-generic-function 'heading-val :lambda-list '(m))
(cl:defmethod heading-val ((m <TrafficLight>))
...
(cl:defmethod points-val ((m <TrafficLight>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <TrafficLight>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'laneIds))))
  ...
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'vps))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'vps))
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'vpe))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'vpe))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TrafficLight>) istream)
  ...
  (cl:setf (cl:slot-value msg 'laneIds) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'laneIds)))
    ...
    (cl:let ((__ros_str_len 0))
      ...
      (cl:setf (cl:slot-value msg 'vps) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'vps) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
    (cl:let ((__ros_str_len 0))
      (cl:setf (cl:ldb (cl:byte 8 0) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'vpe) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'vpe) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TrafficLight>)))
  ...
  "route_mission_handler/TrafficLight")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TrafficLight)))
  "Returns string type for a message object of type 'TrafficLight"
  "route_mission_handler/TrafficLight")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TrafficLight>)))
  ...
  "48c6cfe6d51fe7a3ff894f880970f709")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TrafficLight)))
  "Returns md5sum for a message object of type 'TrafficLight"
  "48c6cfe6d51fe7a3ff894f880970f709")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TrafficLight>)))
  ...
  (cl:format cl:nil "int32 id~%int32[] laneIds~%int32 type~%int32 lightNum~%string vps~%string vpe~%float32 heading~%geometry_msgs/Point[] points~%string[] lights~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TrafficLight)))
  "Returns full string definition for message of type 'TrafficLight"
  (cl:format cl:nil "int32 id~%int32[] laneIds~%int32 type~%int32 lightNum~%string vps~%string vpe~%float32 heading~%geometry_msgs/Point[] points~%string[] lights~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <TrafficLight>))
  (cl:+ 0
     4
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'laneIds) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
     4
     4
     4 (cl:length (cl:slot-value msg 'vps))
     4 (cl:length (cl:slot-value msg 'vpe))
     4
