...
"""autogenerated by genpy from itri_msgs/CarState.msg. Do not edit."""
import codecs
import sys
...
class CarState(genpy.Message):
  _md5sum = "e29dfa68c85fb4e233bbfc19ecfc0749"
  _type = "itri_msgs/CarState"
...
float64 z"""
  ...
  __slots__ = ['header','pose','twist','is_stable','sampler_type','acceleration','jerk']
  _slot_types = ['std_msgs/Header','geometry_msgs/PoseStamped','geometry_msgs/TwistStamped','bool','uint8','float32','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,pose,twist,is_stable,sampler_type,acceleration,jerk
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_6d2B2f().pack(_x.twist.twist.linear.x, _x.twist.twist.linear.y, _x.twist.twist.linear.z, _x.twist.twist.angular.x, _x.twist.twist.angular.y, _x.twist.twist.angular.z, _x.is_stable, _x.sampler_type, _x.acceleration, _x.jerk))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.twist.twist.linear.x, _x.twist.twist.linear.y, _x.twist.twist.linear.z, _x.twist.twist.angular.x, _x.twist.twist.angular.y, _x.twist.twist.angular.z, _x.is_stable, _x.sampler_type, _x.acceleration, _x.jerk,) = _get_struct_6d2B2f().unpack(str[start:end])
      self.is_stable = bool(self.is_stable)
      return self
