...
"""autogenerated by genpy from dbw_pacifica_msgs/DriverInputReport.msg. Do not edit."""
import codecs
import sys
...
class DriverInputReport(genpy.Message):
  _md5sum = "7d92e8189302532750bc994bbf345e99"
  _type = "dbw_pacifica_msgs/DriverInputReport"
...
"""
  __slots__ = ['header','turn_signal','high_beam_headlights','wiper','cruise_resume_button','cruise_cancel_button','cruise_accel_button','cruise_decel_button','cruise_on_off_button','adaptive_cruise_on_off_button','adaptive_cruise_increase_distance_button','adaptive_cruise_decrease_distance_button','driver_door_ajar','passenger_door_ajar','rear_left_door_ajar','rear_right_door_ajar','liftgate_ajar','any_seatbelt_unbuckled','airbag_deployed','door_or_hood_ajar','drive_str_whl_button_a','drive_str_whl_button_b','drive_str_whl_button_c','drive_str_whl_button_d','drive_str_whl_button_e']
  _slot_types = ['std_msgs/Header','dbw_pacifica_msgs/TurnSignal','dbw_pacifica_msgs/HighBeam','dbw_pacifica_msgs/WiperFront','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.turn_signal is None:
        self.turn_signal = dbw_pacifica_msgs.msg.TurnSignal()
      if self.high_beam_headlights is None:
        self.high_beam_headlights = dbw_pacifica_msgs.msg.HighBeam()
      if self.wiper is None:
        self.wiper = dbw_pacifica_msgs.msg.WiperFront()
      ...
      if self.drive_str_whl_button_a is None:
        self.drive_str_whl_button_a = False
      if self.drive_str_whl_button_b is None:
        self.drive_str_whl_button_b = False
      if self.drive_str_whl_button_c is None:
        self.drive_str_whl_button_c = False
      if self.drive_str_whl_button_d is None:
        self.drive_str_whl_button_d = False
      if self.drive_str_whl_button_e is None:
        self.drive_str_whl_button_e = False
    else:
      self.header = std_msgs.msg.Header()
      self.turn_signal = dbw_pacifica_msgs.msg.TurnSignal()
      self.high_beam_headlights = dbw_pacifica_msgs.msg.HighBeam()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.turn_signal.value, _x.high_beam_headlights.status, _x.wiper.status, _x.cruise_resume_button, _x.cruise_cancel_button, _x.cruise_accel_button, _x.cruise_decel_button, _x.cruise_on_off_button, _x.adaptive_cruise_on_off_button, _x.adaptive_cruise_increase_distance_button, _x.adaptive_cruise_decrease_distance_button, _x.driver_door_ajar, _x.passenger_door_ajar, _x.rear_left_door_ajar, _x.rear_right_door_ajar, _x.liftgate_ajar, _x.any_seatbelt_unbuckled, _x.airbag_deployed, _x.door_or_hood_ajar, _x.drive_str_whl_button_a, _x.drive_str_whl_button_b, _x.drive_str_whl_button_c, _x.drive_str_whl_button_d, _x.drive_str_whl_button_e,) = _get_struct_24B().unpack(str[start:end])
      ...
      self.drive_str_whl_button_a = bool(self.drive_str_whl_button_a)
      self.drive_str_whl_button_b = bool(self.drive_str_whl_button_b)
      self.drive_str_whl_button_c = bool(self.drive_str_whl_button_c)
      self.drive_str_whl_button_d = bool(self.drive_str_whl_button_d)
      self.drive_str_whl_button_e = bool(self.drive_str_whl_button_e)
      return self
