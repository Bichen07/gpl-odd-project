...
"""autogenerated by genpy from openpilot_bridge/LongitudinalData.msg. Do not edit."""
import codecs
import sys
...
class LongitudinalData(genpy.Message):
  _md5sum = "ec9fd42d927e2b42fdfea3cf5afe68a1"
  _type = "openpilot_bridge/LongitudinalData"
...
string frame_id
"""
  __slots__ = ['header','accelerations','speeds']
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.accelerations = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
