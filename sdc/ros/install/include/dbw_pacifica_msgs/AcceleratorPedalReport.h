// Generated by gencpp from file dbw_pacifica_msgs/AcceleratorPedalReport.msg
// DO NOT EDIT!


#ifndef DBW_PACIFICA_MSGS_MESSAGE_ACCELERATORPEDALREPORT_H
#define DBW_PACIFICA_MSGS_MESSAGE_ACCELERATORPEDALREPORT_H
...
struct AcceleratorPedalReport_
{
  ...
  typedef boost::shared_ptr< ::dbw_pacifica_msgs::AcceleratorPedalReport_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dbw_pacifica_msgs::AcceleratorPedalReport_<ContainerAllocator> const> ConstPtr;

}; // struct AcceleratorPedalReport_

typedef ::dbw_pacifica_msgs::AcceleratorPedalReport_<std::allocator<void> > AcceleratorPedalReport;

typedef boost::shared_ptr< ::dbw_pacifica_msgs::AcceleratorPedalReport > AcceleratorPedalReportPtr;
typedef boost::shared_ptr< ::dbw_pacifica_msgs::AcceleratorPedalReport const> AcceleratorPedalReportConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dbw_pacifica_msgs::AcceleratorPedalReport_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dbw_pacifica_msgs::AcceleratorPedalReport_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::dbw_pacifica_msgs::AcceleratorPedalReport_<ContainerAllocator1> & lhs, const ::dbw_pacifica_msgs::AcceleratorPedalReport_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::dbw_pacifica_msgs::AcceleratorPedalReport_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dbw_pacifica_msgs::AcceleratorPedalReport_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dbw_pacifica_msgs::AcceleratorPedalReport_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dbw_pacifica_msgs::AcceleratorPedalReport_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dbw_pacifica_msgs::AcceleratorPedalReport_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dbw_pacifica_msgs::AcceleratorPedalReport_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dbw_pacifica_msgs::AcceleratorPedalReport_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dbw_pacifica_msgs::AcceleratorPedalReport_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x79e5f58f94a8fa77ULL;
  static const uint64_t static_value2 = 0xed7d602d29d0230cULL;
};

template<class ContainerAllocator>
struct DataType< ::dbw_pacifica_msgs::AcceleratorPedalReport_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::dbw_pacifica_msgs::AcceleratorPedalReport_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dbw_pacifica_msgs::AcceleratorPedalReport_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dbw_pacifica_msgs::AcceleratorPedalReport_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dbw_pacifica_msgs::AcceleratorPedalReport_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // DBW_PACIFICA_MSGS_MESSAGE_ACCELERATORPEDALREPORT_H
