// Generated by gencpp from file dbw_pacifica_msgs/WatchdogStatus.msg
// DO NOT EDIT!


#ifndef DBW_PACIFICA_MSGS_MESSAGE_WATCHDOGSTATUS_H
#define DBW_PACIFICA_MSGS_MESSAGE_WATCHDOGSTATUS_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::dbw_pacifica_msgs::WatchdogStatus_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dbw_pacifica_msgs::WatchdogStatus_<ContainerAllocator> const> ConstPtr;

}; // struct WatchdogStatus_

typedef ::dbw_pacifica_msgs::WatchdogStatus_<std::allocator<void> > WatchdogStatus;

typedef boost::shared_ptr< ::dbw_pacifica_msgs::WatchdogStatus > WatchdogStatusPtr;
typedef boost::shared_ptr< ::dbw_pacifica_msgs::WatchdogStatus const> WatchdogStatusConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dbw_pacifica_msgs::WatchdogStatus_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dbw_pacifica_msgs::WatchdogStatus_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::dbw_pacifica_msgs::WatchdogStatus_<ContainerAllocator1> & lhs, const ::dbw_pacifica_msgs::WatchdogStatus_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::dbw_pacifica_msgs::WatchdogStatus_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dbw_pacifica_msgs::WatchdogStatus_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dbw_pacifica_msgs::WatchdogStatus_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dbw_pacifica_msgs::WatchdogStatus_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dbw_pacifica_msgs::WatchdogStatus_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dbw_pacifica_msgs::WatchdogStatus_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dbw_pacifica_msgs::WatchdogStatus_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dbw_pacifica_msgs::WatchdogStatus_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3e7ee28e0afc5910ULL;
  static const uint64_t static_value2 = 0x98518c8b9bf36b8aULL;
};

template<class ContainerAllocator>
struct DataType< ::dbw_pacifica_msgs::WatchdogStatus_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::dbw_pacifica_msgs::WatchdogStatus_<ContainerAllocator> >
{
  static const char* value()
  {
    return "uint8 source\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dbw_pacifica_msgs::WatchdogStatus_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dbw_pacifica_msgs::WatchdogStatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dbw_pacifica_msgs::WatchdogStatus_<ContainerAllocator>& v)
  {
    s << indent << "source: ";
...
#endif // DBW_PACIFICA_MSGS_MESSAGE_WATCHDOGSTATUS_H
