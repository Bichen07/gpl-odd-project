...
export function Legend({ sx, clusterCounts }: Props) {
  ...
  const selectedCluster = useAppSelector(
    (state) => state.session.selectedBoundaryDiffCluster,
  );
  ...
  return (
    ...
    >
      <Box component="div">
        <Stack>
          <Typography sx={{ fontSize: 14 }}>Boundary Diff Patterns</Typography>
          <LegendOrdinal
                      ...
                      <Box
                        ...
                        onClick={() => {
                          if (label.text === selectedCluster) {
                            dispatch(
                              sessionSlice.actions.setSelectedBoundaryDiffCluster(
                                null,
                              ),
                            );
                          } else {
