...
export const Plot = ({ data, feature, isBoundaryDiffMode }: Props) => {
  ...
  const timepoints = isBoundaryDiffMode
    ? clusteringResponse?.boundaryDiffClustering.timePoints
    : clusteringResponse?.failureClustering.timePoints;
  ...
  }, [data, boundsWidth, clusteringResponse]);
