...
export default function GradientClusteringResponse() {
  ...
  const clusteringResult = useAppSelector((state) => {
    return state.session.selectedGradientClusteringResult;
  });
  const clusterInfos = useAppSelector((state) => {
    return state.session.gradientClusterInfos;
  });
  ...
  const results = useMemo(() => {
    ...
    return trajectoryAnalysis.clustering.gradients.clustering.results;
  }, [trajectoryAnalysis]);
          ...
          {sortedIndices?.map((index) => {
            ...
            return (
              <Stack
                ...
                onClick={() => {
                  dispatch(
                    sessionSlice.actions.setSelectedGradientClusteringResult(
                      results[index] ?? null,
                    ),
                  );
                  dispatch(
                    sessionSlice.actions.setSelectedGradientClusterInfo(
